...
const Chat = () => {
  ...
  return (
    <div className=" absolute right-5 md:right-52  nav-item top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          <p className="font-semibold text-lg dark:text-gray-200">Messages</p>
          <button type='button' className='text-white tezt-xs rounded p-1 px-2 bg-orange'>
            5 New
          </button>
        </div>
        <Button
